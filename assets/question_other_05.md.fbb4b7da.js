import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.f98883f0.js";const y=JSON.parse('{"title":"antd与tailwindcss冲突","description":"","frontmatter":{"title":"antd与tailwindcss冲突"},"headers":[],"relativePath":"question/other/05.md","filePath":"question/other/05.md","lastUpdated":1709550192000}'),l={name:"question/other/05.md"},e=p(`<p>在 react 项目开发时，常常会使用这两个库，这两个库在一起工作时，在默认情况下会导致样式冲突的问题。</p><p>为了解决此问题，我们需要在 tailwind.config.js 中进行如下配置：</p><div class="language-diff vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">diff</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">/** @type {import(&#39;tailwindcss&#39;).Config} */</span></span>
